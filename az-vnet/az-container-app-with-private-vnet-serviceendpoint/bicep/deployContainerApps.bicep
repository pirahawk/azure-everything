      ...
      containers: [
        {
          ...
          env: [
            ...
            }
            {
              ...
              value: containerManagedIdentity.properties.clientId // I need this because its a user assigned managed identity. https://learn.microsoft.com/en-us/dotnet/api/azure.identity.defaultazurecredential?view=azure-dotnet#examples
            }
            {
              name: 'ServiceName'
            ...
            {
              name: 'BlobStores__0__Name'
              value: '${storageAccount.name}'
            }
            {
              name: 'BlobStores__0__BlobUrl'
              value: '${storageAccount.properties.primaryEndpoints.blob}'
            }
            {
              name: 'BlobStores__0__ContainerName'
              value: 'csvfiles'
            }
          ]
          probes:[
