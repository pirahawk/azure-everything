...
azGroupName="az-blobstore-$randomSuffix"
...
az deployment group create -g $azGroupName -n $azDeploymentName --no-wait -f ./az-blobstore/high-volume-data-load/bicep/blob.bicep \
 --parameters \
