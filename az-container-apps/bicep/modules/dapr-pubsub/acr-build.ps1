...
az acr run --registry $acrName https://github.com/pirahawk/azure-everything.git -f .\az-container-apps\bicep\modules\dapr-pubsub\acr-build-task.yaml --platform linux
